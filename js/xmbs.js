...
Surge
[Script]
小米运动 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js
小米运动获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=backUp/https://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js
圈X
[task_local]
# 小米运动
15 17 * * * https://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body https://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js.js
Loon
[Script]
cron "15 17 * * *" script-path=https://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js, tag=小米运动
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=xhttps://raw.githubusercontent.com/betakernel/myQuantumultX/main/js/xmbs.js, requires-body=true, timeout=3600, tag=小米运动获取Token
 */
...
const step = randomFriendPin($.getdata('xmMinStep')*1 || 12300, $.getdata('xmMaxStep')*1 || 13500);
function getToken() {
  if ($response.body) {
